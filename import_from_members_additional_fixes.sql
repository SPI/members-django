...
insert into members (memid, name, email, iscontrib, ismanager, sub_private, lastactive, createvote) select memid, name, email, iscontrib, ismanager, coalesce(sub_private, false), lastactive, createvote from temp;
